...
function Encontrardata(){
    ...
    if(cielo!="sin seleccionar" && temperatura!="sin seleccionar" && humedad!="sin seleccionar" && viento!="sin seleccionar"){
        ...
        if(cielo=="Soleado" && humedad=="Alta"){
            ...
            var cambio = document.querySelectorAll(".dataobtenidaRP")[0];
            cambio.classList.toggle("resp");
        }
        ...
        if(cielo=="Cubierto"){
            var elements =document.getElementById('#encontrado');
            elements.innerText='Sí puedes jugar';
            var cambio = document.querySelectorAll(".dataobtenidaRP")[0];
            cambio.classList.toggle("resp");
        ...
        alert("Datos incopmpletos no se llega a ninguna conclusión")
        var elements =document.getElementById('#encontrado');
        elements.innerText='Sin conclusión';
    }
